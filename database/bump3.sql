...
CREATE TABLE `registro` (
  ...
  `descricao` varchar(256) DEFAULT NULL,
  `local_ocorrencia` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `uni_atendimento` (`uni_atendimento`),
  KEY `registro_ib_fk2` (`paciente`),
  KEY `registro_idfk_3` (`profissional_responsavel`),
  KEY `registro_idfk_4` (`local_ocorrencia`),
  ...
  CONSTRAINT `registro_idfk_3` FOREIGN KEY (`profissional_responsavel`) REFERENCES `profissional_sus` (`id`),
  CONSTRAINT `registro_idfk_4` FOREIGN KEY (`local_ocorrencia`) REFERENCES `endereco` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2016-11-21 21:57:06
